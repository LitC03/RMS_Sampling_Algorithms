...
% data=double(I(31:130,51:150))+20*(rand(100)-0.5);
% name='cameraman_noise1';

% data=double(I(31:130,51:150))+40*(rand(100)-0.5);
...
save(['algB_',name,'_F',num2str(r_factor),'X',num2str(c_factor),'_std_',num2str(sigma),'_sp',num2str(sp),'.mat'],'M','seen','I','E1','E2','eq_samp','total_runs','NN_M','NN_eq','r_factor','c_factor','path_taken','sp','sigma')
