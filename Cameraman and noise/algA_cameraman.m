...
data=double(I(31:130,51:150));
name='cameraman_clean';

% I=double(I(31:130,51:150))+20*(rand(100)-0.5);
% name='cameraman_noise1';

% I=double(I(31:130,51:150))+40*(rand(100)-0.5);
% name='cameraman_noise2';


%% Set parameters
row_factor=5; % how many rows will be skipped in uniform sampling
col_factor=5; % how many columns will be skipped in uniform samling
sigma = 0.5; % Standard deviation of Gaussian filter
sp = 0; % Scattering probability
